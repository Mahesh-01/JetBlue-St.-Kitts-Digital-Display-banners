...
function setupContent() {
  ...
  if (showDefault) {
    h4[0].innerHTML = "<span class='blue'>Fly with a sky-high experience<br />at down-to-earth fares.</span>"; // - Populates main headline
...
function animate() {
  ...
  tl.set(['#h4', '#priceHolder', '#cta', '#terms_container'], {autoAlpha: 1, force3D: true })
  ...
  .to('#main_content', 1.1, { x:"-=500", ease: Back.easeOut.config(.3) })
